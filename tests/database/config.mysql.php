...
define('DB_POPULATE_FILE', './database/populate.mysql.sql');
define('DB_WIPE_FILE',     './database/wipe.mysql.sql');
...
define('DB_EXTENDED_POPULATE_FILE', './database/populate-extended.mysql.sql');
define('DB_EXTENDED_WIPE_FILE',     './database/wipe-extended.mysql.sql');
