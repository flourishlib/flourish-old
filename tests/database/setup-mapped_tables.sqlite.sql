...
INSERT INTO user (first_name, middle_initial, last_name, email_address, status, times_logged_in, date_created, birthday, time_of_last_login, is_validated, hashed_password) VALUES ('Will', '', 'Bond', 'will@flourishlib.com', 'Active', 5, '2008-05-01 13:00:00', '1980-09-01', '17:00:00', '1', '5527939aca3e9e80d5ab3bee47391f0f');
INSERT INTO user (first_name, middle_initial, last_name, email_address, status, times_logged_in, date_created, birthday, time_of_last_login, is_validated, hashed_password) VALUES ('John', '', 'Smith', 'john@smith.com', 'Active', 1, '2008-02-12 08:00:00', '1965-02-02', '12:00:00', '1', 'a722c63db8ec8625af6cf71cb8c2d939');
INSERT INTO user (first_name, middle_initial, last_name, email_address, status, times_logged_in, date_created, birthday, time_of_last_login, is_validated, hashed_password) VALUES ('Bar', '', 'Sheba', 'bar@example.com', 'Inactive', 0, '2008-01-01 17:00:00', NULL, NULL, '1', 'c1572d05424d0ecb2a65ec6a82aeacbf');
INSERT INTO user (first_name, middle_initial, last_name, email_address, status, times_logged_in, date_created, birthday, time_of_last_login, is_validated, hashed_password) VALUES ('Foo', '', 'Barish', 'foo@example.com', 'Active', 0, '2008-03-02 20:00:00', NULL, NULL, '0', '3afc79b597f88a72528e864cf81856d2');

INSERT INTO "group" (name, group_leader, group_founder) VALUES ('Music Lovers', 1, 2);
INSERT INTO "group" (name, group_leader, group_founder) VALUES ('Musicians', 2, 2);
...
INSERT INTO popular_artists (name) VALUES ('The Postal Service');
INSERT INTO popular_artists (name) VALUES ('Rustic Overtones');
INSERT INTO popular_artists (name) VALUES ('Relient K');

INSERT INTO records (name, year_released, msrp, genre, artist_id) VALUES ('Give Up', 2003, '13.98', 'Alternative', 1);
INSERT INTO records (name, year_released, msrp, genre, artist_id) VALUES ('Viva Nueva!', 2001, '15.99', 'Rock', 2);
INSERT INTO records (name, year_released, msrp, genre, artist_id) VALUES ('Long Division', 1996, '9.99', 'Rock', 2);
INSERT INTO records (name, year_released, msrp, genre, artist_id) VALUES ('Mmhmm', 2004, '12.99', 'Alternative', 3);
INSERT INTO records (name, year_released, msrp, genre, artist_id) VALUES ('Five Score and Seven Years Ago', 2007, '12.99', 'Alternative', 3);
INSERT INTO records (name, year_released, msrp, genre, artist_id) VALUES ('Forget and Not Slow Down', 2009, '12.99', 'Alternative', 3);
INSERT INTO records (name, year_released, msrp, genre, artist_id) VALUES ('Two Lefts Don''t Make a Right...but Three Do', 2003, '11.99', 'Alternative', 3);
